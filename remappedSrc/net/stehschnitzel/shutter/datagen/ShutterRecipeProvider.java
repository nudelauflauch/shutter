...
//        offersDefaultShutter(ModBlocks.WALNUT_SLAB , BlockInit.WALNUT_SHUTTER, exporter);
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.MISC, BlockInit.NETHERITE_SHUTTER)
                ...
                .offerTo(exporter, new Identifier(getRecipeName(BlockInit.NETHERITE_SHUTTER)));
...
//        offersDefaultShutter(UABlocks.RIVER_SLAB, BlockInit.RIVER_SHUTTER, exporter);
        offersDefaultShutter(GoodEndingItems.CYPRESS_SLAB, BlockInit.CYPRESS_SHUTTER, exporter);   //TODO doesnt work because of Good Ending
    ...
    private void offerIngotShutter(Item inputIngot, Item inputNugget, Block outputItem, Consumer<RecipeJsonProvider> exporter) {
    ...
    private void waxed_shutter(Block inputShutter, Block outputItem, Consumer<RecipeJsonProvider> exporter) {
    ...
    private void offersDefaultShutter(Item inputItem, Block outputItem, Consumer<RecipeJsonProvider> exporter) {
        offersDefaultShutter(inputItem, outputItem, 2, exporter);
    }

    private void offersDefaultShutter(Item inputItem, Block outputItem, int count, Consumer<RecipeJsonProvider> exporter) {
