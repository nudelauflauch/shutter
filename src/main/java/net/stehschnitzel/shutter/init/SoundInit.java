...
public class SoundInit {
    ...
    public static final RegistryObject<SoundEvent> SHUTTER_OPEN_HALF_METAL = registerSoundEvent("shutter_open_half_metal");
    public static final RegistryObject<SoundEvent> SHUTTER_OPEN_FULL_METAL = registerSoundEvent("shutter_open_full_metal");
    public static final RegistryObject<SoundEvent> SHUTTER_CLOSE_METAL = registerSoundEvent("shutter_close_metal");
